                    ...
                    <View style = {styles.body}> 
                        ...
                        <View style = {styles.first_box}>
                            <View style = {styles.write_on_the_edges}>
                                <Text style= {{fontSize: 18, marginLeft: 20}}>{this.state.Customer_Name}</Text>
                                <Text style= {{fontSize: 18, marginRight: 20}}>{this.state.Location}</Text>
                            </View>
                            <Text style= {{fontSize: 14, marginLeft: 20}}>{this.state.Phone_Number}</Text>
                        </View>

                        <View style = {styles.textbox}>
                        <View style = {styles.write_on_the_edges}>
                                <Text style= {{fontSize: 18, marginLeft: 20}}>Time</Text>
                                <Text style= {{fontSize: 18, marginRight: 20}}>{this.state.Time}</Text>
                            </View>
                        </View>

                        <View style = {styles.lower_body}>
                            <View style = {{flexDirection: 'row', justifyContent: 'space-around'}} >
                                <Text style= {{fontSize: 12, marginLeft: 20, marginTop: 10, marginBottom: 5}}>Items:</Text> 
                                <Text style= {{fontSize: 12, marginTop: 10, marginBottom: 5}}>Qty</Text>
                                <Text style= {{fontSize: 12, marginRight: 20, marginTop: 10, marginBottom: 5}}>Total Price</Text>
                            </View>
                            
                            {/*Items will come down below here*/}
                            <View style = {{flexDirection: 'row', justifyContent: 'space-around'}} >
                                <Text style= {{fontSize: 18, marginLeft: 20, marginTop: 10, marginBottom: 5}}>Eggs</Text> 
                                <Text style= {{fontSize: 18, marginRight: 30, marginTop: 10, marginBottom: 5}}>6</Text>
                                <Text style= {{fontSize: 18, marginRight: 30, marginTop: 10, marginBottom: 5, color: '#d00c16'}}>70</Text>
                            </View>
                        ...
                        <View style = {{marginTop:20, width: '50%', justifyContent: "center", marginLeft : 100}}>
                            <Button rounded style = {{marginTop: 35, width: '50%'}} title = "Dispatch" color = "#d00f16" onPress = {this.dispatch_buttonhandler}/>   
                        </View>
                    </View>
                </View>
            )
